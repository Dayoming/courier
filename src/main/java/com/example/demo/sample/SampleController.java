...
public class SampleController {
    ...
    final String SEARCH_URL = "https://m.search.naver.com/p/csearch/ocontent/util/headerjson.nhn?_callback=window.__jindo2_callback._7452&callapi=parceltracking&t_code=%s&t_invoice=%s&passportKey=f18b8bf17cf40af3d4cb11eaa651e809b714227f";
    ...
    @Autowired
    OverseasInfoMapper overseasInfoMapper;
    ...
    public String htmlUnit() {
        ...
        final String SEARCH_URL = "https://search.naver.com/search.naver?sm=top_hty&fbm=1&ie=utf8&query=�깮諛�+議고?��";
    ...
    @GetMapping(value = "/overlist", produces = "application/json")
    @ResponseBody
    private List<OverseasInfo> overseasList(@RequestParam String oInvoiceNo) {
    	List<OverseasInfo> overList = overseasInfoMapper.list(oInvoiceNo);
    	return overList;
    }
